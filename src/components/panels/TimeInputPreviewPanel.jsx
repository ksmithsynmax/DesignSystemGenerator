import TimeInputPreview from "../previews/TimeInputPreview";
import SectionLabel from "../shared/SectionLabel";
import PreviewStage from "../shared/PreviewStage";
import PreviewMatrix from "../shared/PreviewMatrix";

export const TIMEINPUT_VARIANTS = ["default"];
export const TIMEINPUT_RADIUS_KEYS = ["default", "xs", "sm", "md", "lg", "xl"];
export const TIMEINPUT_STATES = ["default", "hover", "focus", "error", "disabled"];
...
export function TimeInputPreviewContent({
  brands,
  activeBrand,
  activeVariant,
  activeTimeInputSize,
  activeTimeInputRadius,
  sizeKeys,
  activeColorToken,
  selectedState,
  showLabel,
  ...
  const matrixRows = TIMEINPUT_VARIANTS.flatMap((v) => [
      ...
      <PreviewStage label={activeColorToken}>
        <div style={{ width: 280 }}>
          <TimeInputPreview
            ...
            size={activeTimeInputSize}
            radius={activeTimeInputRadius}
            showLabel={showLabel}
            labelText={labelText}
...
export function TimeInputPropertiesPanel({
  activeTimeInputSize,
  setActiveTimeInputSize,
  activeTimeInputRadius,
  setActiveTimeInputRadius,
  sizeKeys,
  selectedState,
  setSelectedState,
  showLabel,
  ...
  return (
    <div style={{ display: "grid", gap: 10 }}>
      <PropertyRow label="Size" value={activeTimeInputSize} onChange={setActiveTimeInputSize} options={sizeKeys} />
      <PropertyRow label="Radius" value={activeTimeInputRadius} onChange={setActiveTimeInputRadius} options={TIMEINPUT_RADIUS_KEYS} />
      <PropertyRow
        label="State"
        value={selectedState}
        onChange={setSelectedState}
        options={TIMEINPUT_STATES}
