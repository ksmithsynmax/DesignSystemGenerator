import SelectableFilterChipPreview from "../previews/SelectableFilterChipPreview";
import SectionLabel from "../shared/SectionLabel";
import PreviewStage from "../shared/PreviewStage";
import PreviewMatrix from "../shared/PreviewMatrix";

export const SFC_VARIANTS = ["filled", "outline", "light"];
export const SFC_RADIUS_KEYS = ["default", "xs", "sm", "md", "lg", "xl"];
...
export const SFC_STATES = ["default", "hover", "focus", "pressed" /*, "disabled" */];
// Selective state (rows in the spec) collapses selection (checked) and
// availability (inactive) into one friendly control.
export const SFC_SELECTIVE_STATES = ["active", "selected", "inactive", "selective-inactive"];
...
export function SelectableFilterChipPreviewContent({
  brands,
  activeBrand,
  activeVariant,
  activeChipSize,
  ...
  const matrixRows = [
    { label: "active", checked: false, inactive: false },
    { label: "selected", checked: true, inactive: false },
    { label: "inactive", checked: false, inactive: true },
...
export function SelectableFilterChipPropertiesPanel({
  activeVariant,
  setActiveVariant,
  activeChipSize,
  setActiveChipSize,
...
export default function SelectableFilterChipPreviewPanel(props) {
  return (
    <div>
