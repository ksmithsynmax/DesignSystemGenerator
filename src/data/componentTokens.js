...
export const COMPONENT_TOKENS = {
  button: {
    ...
    "button-ghost-text-hover":          { type: "COLOR", semantic: "interactive-primary-hover",    figmaPath: "button/ghost-text-hover" },
    "button-ghost-text-focus":          { type: "COLOR", semantic: "interactive-primary",          figmaPath: "button/ghost-text-focus" },
    "button-ghost-text-pressed":        { type: "COLOR", semantic: "interactive-primary-pressed",  figmaPath: "button/ghost-text-pressed" },
